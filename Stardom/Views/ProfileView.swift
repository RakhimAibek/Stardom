...
class ProfileView: UIView {
    ...
    let titleCVLabel: UILabel = {
        let label = UILabel()
        label.text = "Ваше резюме видно для работадателей"
    ...
    let profileImageView: UIImageView = {
        ...
        imageView.image = UIImage(named: "add_profile_image")
        return imageView
    }()
    ...
    let editButton: UIButton = {
        let button = UIButton(title: "Редактировать резюме", textSize: 18)
    ...
    private func setupViews() {
        self.setGradientLayer(to: editButton)
        ...
        [titleCVLabel, profileImageView, nameDataStackView, additionInfoStackView, descriptionTextView, editButton].forEach {
    ...
    private func setupConstraints() {
        ...
        editButton.anchor(top: descriptionTextView.bottomAnchor, leading: containerView.leadingAnchor, bottom: containerView.bottomAnchor, trailing: containerView.trailingAnchor, padding: .init(top: 8, left: 16, bottom: 0, right: 16), size: .init(width: 0, height: 45))
    }
