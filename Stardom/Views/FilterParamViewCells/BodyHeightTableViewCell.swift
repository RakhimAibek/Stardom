...
class BodyHeightTableViewCell: UITableViewCell {
    
    let chooseHeightLabel: UILabel = {
        let label = UILabel()
        label.text = "выбрать рост, см"
    ...
    private func setupViews() {
        ...
        generalView.addSubview(chooseHeightLabel)
    ...
    private func setupConstraints() {
        ...
        chooseHeightLabel.anchor(top: generalView.topAnchor, leading: generalView.leadingAnchor, bottom: nil, trailing: generalView.trailingAnchor, padding: .init(top: 0, left: 0, bottom: 0, right: 0), size: .init(width: 0, height: 17))
        
        justView.anchor(top: chooseHeightLabel.bottomAnchor, leading: chooseHeightLabel.leadingAnchor, bottom: generalView.bottomAnchor, trailing: chooseHeightLabel.trailingAnchor, padding: .init(top: 10, left: 0, bottom: 0, right: 0), size: .init(width: 0, height: 0))
